package main.java.com.softserve.statics;
...
public class StaticImports {
    ...
    public static void start8TaskConditions() {
        System.out.println("Task 8 starts now!");
        System.out.println("Timmy & Sarah think they are in love, but around where they live, they will only know once they pick a flower each. If one of the flowers has an even number of petals and the other has an odd number of petals it means they are in love.");
        System.out.println("We'll find if it's a true love.");
        System.out.println("Enter amount of Timmy's petals");
    }
}
