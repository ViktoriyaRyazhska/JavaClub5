...
public class Main {
    ...
    private static boolean start(BufferedReader reader) {
        ...
        switch (taskNumber) {
            ...
            case 43 -> Task43.task43(reader);
            case 44 -> Task44.task44(reader);
            case 45 -> Task45.task45(reader);
            case 46 -> Task46.task46(reader);
            case 47 -> Task47.task47(reader);
            case 49 -> Task49.task49(reader);
            case 50 -> Task50.task50(reader);
            case 51 -> Task51.task51(reader);
            case 52 -> Task52.task52(reader);
            case 53 -> Task53.task53(reader);
            case 54 -> Task54.task54(reader);
            case 55 -> Task55.task55(reader);
            case 56 -> Task56.task56(reader);
            case 57 -> Task57.task57(reader);
            case 58 -> Task58.task58(reader);
            case 59 -> Task59.task59(reader);
            case 60 -> Task60.task60(reader);
            case 61 -> Task61.task61(reader);
            case 62 -> Task62.task62(reader);
            case 63 -> Task63.task63(reader);
            case 64 -> Task64.task64(reader);
            case 65 -> Task65.task65(reader);
            case 66 -> Task66.task66(reader);
            case 67 -> Task67.task67(reader);
            case 68 -> Task68.task68(reader);
